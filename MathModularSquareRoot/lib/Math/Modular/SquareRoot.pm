...
# Check a parameter is an integer
...
sub gcd(@)
 {my (@n) = grep {$_} @_;                                                       # Every number divides 0
...
# Validate
  ...
  $_ = abs($_) for @n;                                                          # Sign does not affect divisors


# Find gcd

  my $g = sub                                                                   # Euclid's method
   {my ($a, $b) = @_;
...
$VERSION      = '1.002'; # Sunday 11 September 2016
